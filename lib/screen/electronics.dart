...
class Electronics extends StatelessWidget {
  final title;
  const Electronics({Key? key, this.title}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Future<List<ElectronicsModel>?> _electronicsCall =
    ...
    return Scaffold(
        ...
        body: FutureBuilder<List<ElectronicsModel>?>(
            future: _electronicsCall,
